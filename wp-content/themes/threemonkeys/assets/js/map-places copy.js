...
const PlacesMap = (() => {
  ...
  const renderWidget = (title, id, widgetArea) => {
    ...
    <div class="widget-header">
        ...
        <button class="btn btn-primary btn-close-map collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#map-widget-${id}" aria-expanded="false" aria-controls="map-widget-${id}">
        </button>
    </div>
        <div id="map-widget-${id}" class="map-widget collapse ${
      !isMobile() ? 'show' : ''
    }" data-map-id="${id}">
